...
class ProgramCatalogServiceTests(unittest.TestCase):
    ...
    def test_katalog_soru_seti_db_first_yanitlanir(self) -> None:
        cases = [
            ...
            ("Mühendislik fakültesinde yapay zeka mühendisliği bölümü var mı?", "program_exists_query", "Yapay Zeka Mühendisliği"),
            ("yapay zeka mühendisliği bölümü var mı?", "program_exists_query", "Yapay Zeka Mühendisliği"),
            ...
            ("Mühendislik ve Doğa Bilimleri Fakültesi bölüm mü?", "academic_unit_list_query", "bölüm/program değil"),
