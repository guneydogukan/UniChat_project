...
DEFAULT_TARGET_UNITS: tuple[UnitManagementTarget, ...] = (
    ...
    UnitManagementTarget(
        ...
        22,
        ("iisbf", "iktisadi idari sosyal bilimler"),
    ),
    UnitManagementTarget(
        ...
        24,
        ("gstm", "gsmf", "güzel sanatlar", "mimarlık fakültesi"),
    ),
    UnitManagementTarget(
        ...
        31,
        ("shmyo", "sağlık hizmetleri myo", "sağlık hizmetleri"),
    ),
    UnitManagementTarget(
        ...
        36,
        ("tbmyo", "teknik bilimler myo", "teknik bilimler"),
    ),
    UnitManagementTarget(
