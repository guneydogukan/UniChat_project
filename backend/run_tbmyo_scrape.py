"""
Gorev 3.2.10.2 — Teknik Bilimler MYO: Harita Gudumlu Deep Scrape

MYO genel (BirimID=36) + 3 program:
  - Bilgisayar Teknolojisi / Bilgisayar Programciligi (BirimID=46)
  - Elektronik ve Otomasyon / Radyo Televizyon Teknolojisi (BirimID=?)
  - Makine ve Metal Teknolojisi / Makine Programi (BirimID=?)
...
TBMYO_DIR = MYO_ROOT / "Teknik Bilimler Meslek Yüksekokulu"

BLUEPRINTS = [
    {
        "file": MYO_ROOT / "Teknik_Bilimler_Meslek_Yüksekokulu_Genel_Yapısı.html",
        "department": "Teknik Bilimler MYO",
        "contact_unit": "TBMYO Mudurlugu",
        "contact_info": "teknikbilimler@gibtu.edu.tr",
    },
    {
        "file": TBMYO_DIR / "Bilgisayar_Teknolojisi_Bölümü-Bilgisayar_Programcılığı.html",
        "department": "Bilgisayar Programciligi Programi",
        "contact_unit": "Bilgisayar Teknolojisi Bolumu",
        "contact_info": "teknikbilimler@gibtu.edu.tr",
    },
    {
        "file": TBMYO_DIR / "Elektronik_ve_Otomasyon_Bölümü-Radyo_ve_Televizyon_Teknolojisi.html",
        "department": "Radyo ve Televizyon Teknolojisi Programi",
        "contact_unit": "Elektronik ve Otomasyon Bolumu",
        "contact_info": "teknikbilimler@gibtu.edu.tr",
    },
    {
        "file": TBMYO_DIR / "Makine_ve_Metal_Teknolojisi_Bölümü-Makine_Programı.html",
        "department": "Makine Programi",
        "contact_unit": "Makine ve Metal Teknolojisi Bolumu",
        "contact_info": "teknikbilimler@gibtu.edu.tr",
    },
]
...
def phase1_blueprint_check():
    print("=" * 65)
    print("FAZ 1: Blueprint Parse — TBMYO Tum Birimler")
    print("=" * 65)
    total_urls = 0
    found = 0
...
def phase2_full_scrape():
    ...
    print("\n" + "=" * 65)
    print("FAZ 2: Canli Deep Scrape + DB Yukleme — TBMYO Tum Birimler")
    print("=" * 65)
    all_reports = []
    for bp_info in BLUEPRINTS:
        bp_file = bp_info["file"]
        ...
        json_path = OUTPUT_DIR / f"tbmyo_{safe_name}_output.json"
...
def phase3_validation(all_reports):
    print("\n" + "=" * 65)
    print("FAZ 3: Dogrulama — TBMYO Toplam")
    print("=" * 65)
    checks = []
    ...
    check("valid >= 15", total_valid >= 15, f"got {total_valid}")
    check("docs >= 15", total_docs >= 15, f"got {total_docs}")
...
def main():
    ...
    print("\n" + "=" * 65)
    print(f"GOREV 3.2.10.2 — TBMYO Deep Scrape {'TAMAMLANDI' if success else 'BASARISIZ'}!")
    print("=" * 65)

    summary = {"task": "3.2.10.2", "description": "TBMYO Harita Gudumlu Deep Scrape", "birimler": []}
    for entry in all_reports:
        r = entry["report"]
    ...
    summary_path = OUTPUT_DIR / "tbmyo_summary.json"
