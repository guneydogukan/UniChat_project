"""
Gorev 3.2.12 — Daire Baskanliklari: Harita Gudumlu Deep Scrape

3 birim:
  - Ogrenci Isleri Daire Bsk. (BirimID=4)   -> category: ogrenci_isleri
  - Kutuphane ve Dokumantasyon Daire Bsk. (BirimID=7) -> category: kutuphane
  - Saglik Kultur ve Spor Daire Bsk. (BirimID=8) -> category: spor
...
BLUEPRINTS = [
    {
        "file": GIBTU / "Öğrenci_İşleri_Daire_Başkanlığı.html",
        "department": "Ogrenci Isleri Daire Baskanligi",
        "contact_unit": "Ogrenci Isleri Daire Baskanligi",
        "contact_info": "ogrenciisleri@gibtu.edu.tr",
        "category": "ogrenci_isleri",
    },
    {
        "file": GIBTU / "Kütüphane_ve_Dokümantasyon_Daire_Başkanlığı.html",
        "department": "Kutuphane ve Dokumantasyon Daire Baskanligi",
        "contact_unit": "Kutuphane ve Dokumantasyon Daire Baskanligi",
        "contact_info": "kutuphane@gibtu.edu.tr",
        "category": "kutuphane",
    },
    {
        "file": GIBTU / "Sağlık_Kültür_ve_Spor_Daire_Başkanlığı.html",
...
def phase1_blueprint_check():
    print("=" * 65)
    print("FAZ 1: Blueprint Parse — Daire Baskanliklari")
    print("=" * 65)
    total_urls = 0
    found = 0
...
def phase2_full_scrape():
    print("\n" + "=" * 65)
    print("FAZ 2: Canli Deep Scrape + DB Yukleme — Daire Baskanliklari")
    print("=" * 65)
    all_reports = []
    for bp_info in BLUEPRINTS:
        bp_file = bp_info["file"]
        ...
        json_path = OUTPUT_DIR / f"daire_{safe_name}_output.json"
...
def phase3_validation(all_reports):
    print("\n" + "=" * 65)
    print("FAZ 3: Dogrulama — Daire Baskanliklari Toplam")
    print("=" * 65)
    checks = []
...
def main():
    ...
    print("\n" + "=" * 65)
    print(f"GOREV 3.2.12 — Daire Baskanliklari Deep Scrape {'TAMAMLANDI' if success else 'BASARISIZ'}!")
    print("=" * 65)

    summary = {"task": "3.2.12", "description": "Daire Baskanliklari Harita Gudumlu Deep Scrape", "birimler": []}
    for entry in all_reports:
        r = entry["report"]
    ...
    summary_path = OUTPUT_DIR / "daire_summary.json"
