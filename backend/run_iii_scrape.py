"""
Gorev 3.2.8.5 — Iktisadi Idari ve Sosyal Bilimler Fakultesi: Harita Gudumlu Deep Scrape

Fakulte genel (BirimID=22) + Mutercim Tercumanlik Bolumu (BirimID=94)
...
III_DIR = GIBTU / "FAKÜLTELER" / "İktisadi İdari ve Sosyal Bilimler Fakültesi"

BLUEPRINTS = [
    {
        "file": III_DIR / "İktisadi_İdari_ve_Sosyal_Bilimler_Fakültesi.html",
        "department": "Iktisadi Idari ve Sosyal Bilimler Fakultesi",
        "contact_unit": "IISBF Dekanligi",
        "contact_info": "iii@gibtu.edu.tr",
    },
    {
        "file": III_DIR / "Mütercim_Tercümanlık_Bölümü.html",
        "department": "Mutercim Tercumanlik Bolumu",
        "contact_unit": "Mutercim Tercumanlik Bolumu",
        "contact_info": "mutercimtercumanlik@gibtu.edu.tr",
    },
]
...
def phase1_blueprint_check():
    print("=" * 65)
    print("FAZ 1: Blueprint Parse — IISBF Tum Birimler")
    print("=" * 65)
    total_urls = 0
...
def phase2_full_scrape():
    ...
    print("\n" + "=" * 65)
    print("FAZ 2: Canli Deep Scrape + DB Yukleme — IISBF Tum Birimler")
    print("=" * 65)
    all_reports = []
    for bp_info in BLUEPRINTS:
        bp_file = bp_info["file"]
        ...
        json_path = OUTPUT_DIR / f"iii_{safe_name}_output.json"
...
def phase3_validation(all_reports):
    print("\n" + "=" * 65)
    print("FAZ 3: Dogrulama — IISBF Toplam")
    print("=" * 65)
    checks = []
...
def main():
    ...
    print("\n" + "=" * 65)
    print(f"GOREV 3.2.8.5 — IISBF Deep Scrape {'TAMAMLANDI' if success else 'BASARISIZ'}!")
    print("=" * 65)

    summary = {"task": "3.2.8.5", "description": "IISBF Harita Gudumlu Deep Scrape", "birimler": []}
    for entry in all_reports:
        r = entry["report"]
    ...
    summary_path = OUTPUT_DIR / "iii_summary.json"
