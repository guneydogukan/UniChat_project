"""
Gorev 3.2.8.6 — Guzel Sanatlar Tasarim ve Mimarlik Fakultesi: Harita Gudumlu Deep Scrape

Fakulte genel (BirimID=24) + Gastronomi ve Mutfak Sanatlari Bolumu (BirimID=105)
...
GSMF_DIR = GIBTU / "FAKÜLTELER" / "Güzel Sanatlar Tasarım ve Mimarlık Fakültesi"

BLUEPRINTS = [
    {
        "file": GSMF_DIR / "Güzel_Sanatlar_Tasarım_ve_Mimarlık_Fakültesi.html",
        "department": "Guzel Sanatlar Tasarim ve Mimarlik Fakultesi",
        "contact_unit": "GSTMF Dekanligi",
        "contact_info": "gsmf@gibtu.edu.tr",
    },
    {
        "file": GSMF_DIR / "Gastronomii_ve_Mutfak_Sanatları.html",
        "department": "Gastronomi ve Mutfak Sanatlari Bolumu",
        "contact_unit": "Gastronomi ve Mutfak Sanatlari Bolumu",
        "contact_info": "gastronomi@gibtu.edu.tr",
    },
]
...
def phase1_blueprint_check():
    print("=" * 65)
    print("FAZ 1: Blueprint Parse — GSTMF Tum Birimler")
    print("=" * 65)
    total_urls = 0
...
def phase2_full_scrape():
    ...
    print("\n" + "=" * 65)
    print("FAZ 2: Canli Deep Scrape + DB Yukleme — GSTMF Tum Birimler")
    print("=" * 65)
    all_reports = []
    for bp_info in BLUEPRINTS:
        bp_file = bp_info["file"]
        ...
        json_path = OUTPUT_DIR / f"gsmf_{safe_name}_output.json"
...
def phase3_validation(all_reports):
    print("\n" + "=" * 65)
    print("FAZ 3: Dogrulama — GSTMF Toplam")
    print("=" * 65)
    checks = []
...
def main():
    ...
    print("\n" + "=" * 65)
    print(f"GOREV 3.2.8.6 — GSTMF Deep Scrape {'TAMAMLANDI' if success else 'BASARISIZ'}!")
    print("=" * 65)

    summary = {"task": "3.2.8.6", "description": "GSTMF Harita Gudumlu Deep Scrape", "birimler": []}
    for entry in all_reports:
        r = entry["report"]
    ...
    summary_path = OUTPUT_DIR / "gsmf_summary.json"
